...
var initialState=_screens.AppNavigator.router.getStateForAction(_screens.AppNavigator.router.getActionForPathAndParams(_constants2.default.HelloWorld));
...
var reducers=(0,_redux.combineReducers)({form:_reduxForm.reducer,nav:navReducer});exports.default=

function(){
var sagaMiddleware=(0,_reduxSaga2.default)();
var middlewares=[_reduxThunk2.default,sagaMiddleware,logAction];
