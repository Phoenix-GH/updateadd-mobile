...
_react2.default.createElement(AppNavigator,{navigation:(0,_reactNavigation.addNavigationHelpers)({dispatch:props.dispatch,state:props.nav,addListener:_store.addListener}),__source:{fileName:_jsxFileName,lineNumber:24}}));};
